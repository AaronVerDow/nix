...
-- move between lines as visually wrapped
...
vim.api.nvim_create_augroup("RmdSettings", { clear = true })

-- Apply settings only when opening .Rmd files
vim.api.nvim_create_autocmd("FileType", {
  pattern = "rmd", -- The filetype for R Markdown
  group = "RmdSettings",
  callback = function()
    -- Use actual tab characters (do NOT convert to spaces)
    vim.opt_local.expandtab = false
    -- Display these tab characters as 4 spaces wide
    vim.opt_local.tabstop = 4
    -- Use the same 4-space width for auto-indentation operations
    vim.opt_local.shiftwidth = 4
    -- Make backspace delete one 'shiftwidth' worth of indentation
